...
**Lưu ý:** Trong danh sách các thiết bị cấm sử dụng tại Doanh nghiệp sản xuất hoặc chỉ định cụ thể cho cá nhân hoặc nhóm/tổ "User/Group/co-hort" được phép sử dụng trong mục đích cụ thể có giám sát hành vi, dữ liệu phần mềm...
